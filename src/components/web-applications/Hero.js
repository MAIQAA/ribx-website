...
const Hero = () => {
  ...
  return (
    <main className="bg-[#16091F] w-full relative h-full lg:h-[800px] flex items-center justify-center z-10 overflow-hidden">
      {/* SHAPES */}
      ...
      <section className="relative container w-full mx-auto h-full flex flex-col md:flex-row items-center justify-between px-4 md:px-8 xl:px-12 py-16 md:py-32">
        ...
        <div
          ref={ref}
          className={`text-white text-start w-full md:w-[43%] space-y-10 z-10 ${
        ...
        <div
          ref={ref}
          className={`w-full md:w-[50%] flex flex-col items-center justify-center mt-10 lg:mt-0 relative ${
